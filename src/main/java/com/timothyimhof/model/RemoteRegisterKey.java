 ...
 */
public class RemoteRegisterKey implements Comparable<RemoteRegisterKey>
{
    private final String remote;// Remote Unit for a station (R051)
    private final Date timestamp;

    public RemoteRegisterKey(String remote, Date timestamp)
    {
        this.remote = remote;
    ...
    {
        RemoteRegisterKey remoteRegisterKey = (RemoteRegisterKey) o;
        EqualsBuilder builder = new EqualsBuilder();
        builder.append(this.remote, remoteRegisterKey.remote);
        builder.append(this.timestamp, remoteRegisterKey.timestamp);
        return builder.isEquals();
    }

    @Override
    public int compareTo(RemoteRegisterKey remoteRegisterKey)
    {
    ...
    {
        return String.format("%s, %s", remote, timestamp.toString());
    }
}
